...
namespace vc4c
{
     ...
     */
    template <>
    struct ScopedInstructionWalker<BasicBlock>
        : public InstructionWalker,
          public std::iterator<std::bidirectional_iterator_tag, intermediate::IntermediateInstruction*,
              intermediate::IntermediateInstruction*, intermediate::IntermediateInstruction*>
    {
        explicit ScopedInstructionWalker() {}
        explicit ScopedInstructionWalker(InstructionWalker it) : InstructionWalker(it) {}
        ScopedInstructionWalker(BasicBlock* basicBlock, intermediate::InstructionsIterator pos) :
            InstructionWalker(basicBlock, pos)
        {
        }
    ...
    template <>
    struct ScopedInstructionWalker<Method>
        : public InstructionWalker,
          public std::iterator<std::bidirectional_iterator_tag, intermediate::IntermediateInstruction*,
              intermediate::IntermediateInstruction*, intermediate::IntermediateInstruction*>
    {
