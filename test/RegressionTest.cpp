...
static std::vector<Entry> allKernels = {
    ...
    Entry{EMULATED, FAST, "./testing/test_shuffle.cl", ""},
    ...
    Entry{EMULATED, FAST, "./testing/deepCL/inv.cl", ""},
    Entry{EMULATED, FAST, "./testing/deepCL/memset.cl", ""},
    ...
    Entry{PENDING_SPIRV_CI, FAST, "./testing/JohnTheRipper/o5logon_kernel.cl", ""},
    // TODO freezes/hangs llvm-spirv/the calling of it
    ...
    Entry{EMULATED, FAST, "./testing/boost-compute/adjacent_find.cl", ""},
    ...
    Entry{EMULATED, FAST, "./testing/boost-compute/test_insertion_sort.cl", ""},
