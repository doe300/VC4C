...
void TestInstructions::testOpCodes()
{
	...
	TEST_ASSERT_EQUALS(INT_ZERO, OP_CLZ(INT_ZERO, NO_VALUE).value());
	...
	TEST_ASSERT_EQUALS(FLOAT_ONE, OP_FMINABS(FLOAT_ZERO, FLOAT_MINUS_ONE).value());
	...
	TEST_ASSERT_EQUALS(INT_ZERO, OP_V8ADDS(INT_ONE, INT_ZERO).value());
