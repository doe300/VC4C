...
namespace vc4c
{
    namespace intermediate
    {
         ...
         */
        InstructionWalker insertRestoreSign(
            InstructionWalker it, Method& method, const Value& src, Value& dest, const Value& sign);

        InstructionWalker insertCalculateIndices(InstructionWalker it, Method& method, const Value& container,
         ...
         *
         * If the output Value is undefined, allowConstantCalculation is set and all required operands are constant, no
         * instruction is inserted, but the output Value is set to the constant result. In any other case, an
         * instruction is generated
         *
         * NOTE:
         * The resulting InstructionWalker and Value can be extracted with std::tie()
         */
        InstructionWalker insertOperation(const OpCode& opCode, InstructionWalker it, Method& method, Value& output,
            const Value& firstOperand, const Optional<Value>& secondOperand = NO_VALUE,
            bool allowConstantCalculation = true);
        InstructionWalker insertMove(InstructionWalker it, Method& method, Value& output, const Value& source,
            bool allowConstantCalculation = true);
    } // namespace intermediate
} // namespace vc4c
