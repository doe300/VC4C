...
void TestInstructions::testPackModes()
{
    ...
    TEST_ASSERT_EQUALS(Value(Literal(0x80000000u), TYPE_INT16), PACK_32_16B_S(Value(Literal(0x87654321u), TYPE_INT32)));
    TEST_ASSERT_EQUALS(Value(Literal(0x7FFF0000u), TYPE_INT16), PACK_32_16B_S(Value(Literal(0x12345678u), TYPE_INT32)));
    ...
    TEST_ASSERT_EQUALS(Value(Literal(0xFF000000u), TYPE_INT8), PACK_32_8D_S(Value(Literal(0x12345678u), TYPE_INT32)));
